...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb  4 19:54:50 2018
...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 16 12:10:20 2017
...
search_handle = Entrez.esearch(db="nucleotide", term='"foxo"[PROTEINFULLNAME] AND "arthropods"[porgn] AND 0:10000[Sequence Length]',
...
#print(IDs)
out_handle = open("foxo-arth.txt", "w")       # open file where you save the result to                                 !<<----Check!
for seq_id in IDs:
...
# I need to establish a way to implement a subruotine (running Terminal commands on Python)... by the time I leave this lab.
# blastn -db Gryllus_rubens_bimac_firmus_TranscriptomeX3 -query GST-arth.txt -out Blastres-GST-TrX3.xml -outfmt 5 -evalue 0.5


# %% <<<<<  Filter BLAST result, saving to a text file >>>>>>>>
import xml.etree.ElementTree as ET
tree = ET.parse("Blastres-foxo-trX3.xml")                                        #!<<----Check!
root = tree.getroot()
query = root[8]     #assing new object 'query' to root[8] for convenience
res = open("Blastres-foxo-selected.txt", "w")                                #!<<----Check!
